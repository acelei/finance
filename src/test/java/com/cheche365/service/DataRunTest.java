...
public class DataRunTest {
    ...
    public void run() throws SQLException {
        List<GroovyRowResult> rows = baseSql.rows("select `type` from table_type where flag>0 and flag!=2");
    ...
    public void result() throws SQLException {
        ...
        for (GroovyRowResult it : rows) {
            ...
            baseSql.executeUpdate("update table_type set flag=4 where `type`=?", new Object[]{type});
        }
    }
